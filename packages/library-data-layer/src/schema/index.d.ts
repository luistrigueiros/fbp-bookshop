...
export declare const bookRelations: import("drizzle-orm").Relations<"book", {
    gender: import("drizzle-orm").One<"gender", false>;
    publisher: import("drizzle-orm").One<"publisher", false>;
}>;
export declare const genderRelations: import("drizzle-orm").Relations<"gender", {
    books: import("drizzle-orm").Many<"book">;
}>;
export declare const publisherRelations: import("drizzle-orm").Relations<"publisher", {
    books: import("drizzle-orm").Many<"book">;
}>;
