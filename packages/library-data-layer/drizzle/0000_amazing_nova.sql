CREATE TABLE `book` (
	...
	`media_folder_id` text DEFAULT '' NOT NULL,
...
CREATE UNIQUE INDEX `book_media_folder_id_idx` ON `book` (`media_folder_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `book_media_book_idx` ON `book_media` (`book_id`);--> statement-breakpoint
CREATE UNIQUE INDEX `book_media_r2key_idx` ON `book_media` (`r2_key`);--> statement-breakpoint
CREATE INDEX `book_media_primary_idx` ON `book_media` (`book_id`,`is_primary`);--> statement-breakpoint
