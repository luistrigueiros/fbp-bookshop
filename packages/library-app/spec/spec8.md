...
2. The display should now be changed to be table-like view where in the first tab allow viewing the list and filter to select one record to edit or delete.
3. In the second tab it will allow drill down into the data.
    3.1. Display the aggregate grouping of book per genre or publisher.
...
6. Implementing this functionalit will require changes to [](../src/frontend/routes/genres.tsx) and [](../src/frontend/routes/publishers.tsx)