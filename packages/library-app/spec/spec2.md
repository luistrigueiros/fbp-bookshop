...
Equally create the a similar wrangler.toml.template file for the library-app subpackage for and incorporate it into the CI/CD pipeline for the library-app subpackage, in this case the worker will not need a queue, nor upload bucket yet.
